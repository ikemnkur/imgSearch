        ...
        {imageData ? (
          <>
            ...
            <div>
              ...
              <button
                style={{ marginRight: 50, width: 150, background: 'purple', padding: '10px', color: 'white', textDecoration: 'none' }}
                href={'http://localhost:3000' + imageData.url}
                download
              >
                Download
              </button>
              <button style={{ marginRight:50, width: 150, }} onClick={() => window.history.back()}>Back</button>
              <button style={{ marginRight:50, width: 150, background: '#FF3333', }} onClick={() => navigate(`/`)}>Main</button>
            </div>
          </>
        ) : (
          <>
